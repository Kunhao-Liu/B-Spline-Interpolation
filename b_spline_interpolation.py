...
def b_spline_interpolation(data_points, degree=3, plot=False, write_to_file=False):
    ...
    return control_x, control_y, knot_vector
...
if __name__ == '__main__':
    ...
    b_spline_interpolation(3, data_points, plot=True)